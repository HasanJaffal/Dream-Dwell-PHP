            ...
            <div class="form-row align-items-center my-2">
                <div class="col-auto">
                    <select class="form-control" name="filterHeader">
                        ...
                        <option value="num_beds">Number of Beds</option>
                        <option value="description">Description</option>
                        <option value="booked">Booked Status</option>
                ...
                <div class="col-auto">
                    <a href="displayRoom.php" class="btn btn-danger">Remove Filter</a>
                </div>
            </div>
        </form>
        <!-- Add Plan Button -->
                ...
                if ($result) {
                    while ($row = mysqli_fetch_assoc($result)) {
                        ...
                        <tr>
                            ...
                            <td scope="row"><img width="60" height="60" src="/CRUD/assets/images/' . (string)$image . '"/></td>
                            <td scope="row">' . $num_beds . '</td>
                            <td scope="row">' . $description . '</td>
                            <td scope="row">' . $booked . '</td>
                            <td scope="row">' . $cost . '</td>

                            <td>
                                <button class="btn btn-primary"><a class="text-light" href="updateRoom.php?_id=' . $_id . '">Update</a></button>
                                <button class="btn btn-danger"><a class="text-light" href="deleteRoom.php?_id=' . $_id . '">Delete</a></button>
                            </td>
                        </tr>
                        ';
                    }
